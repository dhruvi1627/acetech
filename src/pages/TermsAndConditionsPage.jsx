...
export default function TermsAndConditionsPage() {
  return (
    <div className="text-white min-h-screen tracking-wider font-roboto">
      {/* Privacy Policy Content */}
      <div className="max-w-6xl mx-auto px-6 mt-20">
        {/* Header Section */}
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bebas text-white tracking-wider uppercase">
            Terms & Conditions
          </h1>
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bebas text-white mb-2 uppercase tracking-wider">
            Interpretation
          </h2>
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
          ...
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
            ...
            this Agreement) refers to AceTechInside 63 rue Tolbiac 75013 Paris
          </p>
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
          ...
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
            ...
            <a
              ...
              className="text-[#ff38b2] hover:text-[#c22baa]"
            >
          ...
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
            Website refers to Ace Tech Insde, accessible from{" "}
            <a
              href="https://acetechinside.tech/"
              className="text-[#ff38b2] hover:text-[#c22baa]"
            >
        ...
        <div className="mb-10">
          ...
          <h2 className="text-lg font-bebas text-white mb-2 uppercase tracking-wider">
            Severability
          </h2>
          <p className="text-[#cccccc] mb-4 text-sm font-roboto">
        ...
        <div className="mb-10">
          ...
          <div className="text-gray-300 space-y-2 text-sm">
            <p>
              By email:{" "}
              <a
                href="mailto:info@acetechinside.tech"
                className="text-[#ff38b2]"
              >
