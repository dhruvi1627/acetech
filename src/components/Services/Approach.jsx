...
const Approach = () => {
  return (
    <section className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10 ml-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-block">
              <span className="text-xl font-semibold uppercase tracking-widest font-bebas">
                Creative Approach
              </span>
            </div>

            {/* Main heading */}
            <h2 className="text-5xl lg:text-5xl font-bold leading-tight font-bebas tracking-widest">
            ...
            {/* Description */}
            <p className="text-xl text-gray-300 leading-relaxed max-w-lg mt-6 font-roboto">
