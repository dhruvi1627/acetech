            ...
            <div className="space-y-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed font-roboto">
                  Many businesses struggle to make informed decisions due to the
                  overwhelming amount of data available and the difficulty of
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed font-roboto">
                  Our data analytics and AI solutions empower you to make
                  data-driven decisions with confidence. By transforming raw
                  data into meaningful insights, we help you identify trends,
                  predict outcomes, and optimize strategies, leading to better
