        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start pt-20">
          ...
          <div className="space-y-8 tracking-wider">
            ...
            <p className="text-gray-300 leading-relaxed max-w-2xl font-roboto">
              In today's digital age, data is one of the most valuable assets a business can possess. 
              Leveraging advanced data analytics and artificial intelligence (AI) can provide insights 
              that drive smarter decisions, optimize operations, and fuel innovation. At ATI, we 
              specialize in harnessing the power of data and AI to transform businesses, delivering 
              cutting-edge solutions that give you a competitive edge in the marketplace.
            </p>
