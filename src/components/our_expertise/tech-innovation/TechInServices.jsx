...
import DrivingDigitalTransformation from "../../../assets/images/our-expertise/tech-innovation/Driving-Digital-Transformation-1.jpg";
import ServicesSection from "../common/ServicesSection";

const TechInServices = () => {
  const services = [
    {
      title: "Blockchain Technology",
      content:
        "Blockchain is transforming industries by providing secure, transparent, and decentralized solutions for transactions, data sharing, and contract management. ATI’s blockchain expertise includes developing smart contracts, decentralized applications (DApps), and blockchain-based systems that enhance security, transparency, and efficiency. We help businesses leverage blockchain to streamline operations, reduce costs, and build trust with their stakeholders.",
    },
    {
      title: "Internet of Things (IoT)",
      content:
        "IoT connects the physical and digital worlds, enabling real-time monitoring, data collection, and automation across a wide range of applications. ATI’s IoT solutions include the design, development, and deployment of IoT ecosystems that integrate devices, sensors, and data analytics to improve efficiency and drive innovation. From smart manufacturing and connected healthcare to smart cities and retail, our IoT expertise helps businesses transform their operations and customer experiences.",
    },
    {
      title: "Cloud Computing & Edge Computing",
      content:
        "Cloud computing is the backbone of modern digital infrastructure, providing scalable, flexible, and cost-effective solutions for data storage, processing, and application deployment. ATI’s cloud computing services encompass cloud migration, infrastructure management, and cloud-native application development across platforms like AWS, Microsoft Azure, and Google Cloud. Additionally, our edge computing solutions bring processing power closer to data sources, enabling real-time analytics and reducing latency for critical applications.",
    },
    {
