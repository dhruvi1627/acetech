...
const cards = [
  {
    title: "ELITE TALENT SOLUTION",
    desc: "Finding and Managing the Right People",
  },
  {
    title: "ADVANCE TECH SERVICES",
    desc: "Building a Robust Technological Foundation",
  },
  {
...
export default function SmesContent() {
  ...
  return (
    <div className="text-white font-roboto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-48 tracking-wider">
      <h1 className="text-sm sm:text-base md:text-lg font-roboto leading-relaxed">
        At AceTechInside, we understand the unique challenges faced by Small and Medium Enterprises (SMEs). To stay competitive and grow, SMEs need access to top talent and cutting-edge technology solutions. We offer tailored services to help your business thrive by providing exceptional talent and advanced tech solutions, backed by insights from experts.
      </h1>
