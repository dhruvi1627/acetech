          ...
          {[1, 2, 3].map((id) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div
                  className={`rounded-full w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 mx-auto mb-4 flex items-center justify-center cursor-pointer transition-all duration-300 ${
                    hoveredCard === id ? "bg-blue-500" : "bg-gray-800"
                  }`}
                >
                  <img
                    src={data.image}
