  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundPosition: "left -250px top 50px",
      }}
    >
      <div className="container mx-auto text-center relative z-10">
        ...
        <h3 className="text-5xl font-bold mb-4 font-bebas relative inline-block">
          ...
          <span
            className="absolute bottom-0 left-0 h-1 bg-white transition-width duration-500"
            style={{
              width: `${talentType.length > 0 ? talentType.length * 20 : 0}px`,
            }}
          ></span>
        </h3>
...
//           <div className="w-80">
//             {/* Icon */}
//             <div className="bg-gray-800 rounded-full w-40 h-40 mx-auto mb-4 flex items-center justify-center hover:bg-blue-500 cursor-pointer">
//               <img
//                 src={Mask_groupHome_page_2}
//                 alt="Task Force Icon"
//                 className="rounded-full"
